        ...
        <div class="image-info">
            ...
            <div class="metadata">
                ...
                <div class="metadata-item">
                    ...
                    <div class="metadata-value"><?php echo $imageInfo[0] . ' × ' . $imageInfo[1]; ?> px</div>
                </div>
                <?php endif; ?>
                
                <?php if (isset($panorama['filesize'])): ?>
                <div class="metadata-item">
                    <div class="metadata-label">File Size</div>
                    <div class="metadata-value"><?php echo round($panorama['filesize'] / 1024 / 1024, 2); ?> MB</div>
                </div>
                <?php endif; ?>
